...
console.log(`It will take ${spacecraftName} approximately ${getDaysToLocation(kilometersToMoon)} days to reach the Moon.`);
*/
...
console.log(`It will take ${spaceShuttle.name} approximately ${spaceShuttle.getDaysToLocation(kilometersToMoon)} days to reach the Moon.`);
*/
